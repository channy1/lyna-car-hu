  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>RICKSHAW RENTAL LIST CONTROL PANEL</h1>
			<a href="add.php" class="btn btn-success">Add New <i class="fa fa-plus"></i></a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">HOME</a></li>
              <li class="breadcrumb-item active">RICKSHAW RENTAL LIST</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                     ...
                     if ($result->num_rows > 0) {
						...
						$delete_url="dalete.php?delete_id=".$row['ve_id'];	?>
                             ...
                             <tr>
                              ...
                              <td> <?php echo $row["ve_vehical_type"]; ?></td>
                              <td> <?php echo $row["ve_type"]; ?></td>
                              <td> <?php echo $row["ve_maximum_weight"]; ?></td>
                              <td> <?php echo $row["ve_no_of_axles"]; ?></td>
                              <td> <?php echo $row["ve_no_of_eylinders"]; ?></td>
                              <td> <?php echo $row["ve_cylinders_disp"]; ?></td>
                              <td> <?php echo $row["ve_test_drive_url"]; ?></td>
                              <td> <?php echo $row["ve_show_url"]; ?></td>
                              <td> <?php echo $row["ve_note"]; ?></td>
                              <td> <?php echo $row["ve_detail"]; ?></td>
							 
                              
                              <td><a href="edit.php?edit_id=<?php echo $row['ve_id'];?>" class="btn btn-success">Edit</a>
							  <a href="#" onclick="delete_data('<?php echo $delete_url;?>')" 
							  class="btn btn-danger" title="delete"><i class="fa fa-trash"></i> Delete</a></td>
                            </tr>
