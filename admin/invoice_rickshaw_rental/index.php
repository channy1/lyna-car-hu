...
require '../sidebar.php';
 ...
 $query="SELECT * FROM tbl_quotation_admin INNER JOIN tbl_users ON tbl_quotation_admin.customer_id=tbl_users.user_id WHERE tbl_quotation_admin.subject_type='2' ";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> RICKSHAW RENTAL INVOICE CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Rickshaw Rental Invoice </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                             ...
                             <tr>
                               <td>
								<a href="view_info.php?id=<?php echo $row['q_id']; ?>">
									<?php echo $row['user_first_name'].$row['user_last_name']; ?></a>
								</td>
