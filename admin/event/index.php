...
<?php  $images=$row["images"]; ?>
							 ...
							 <td><?php echo $row["e_pro_id"]; ?></td>                              
                               <td><img  width='100px' height='100px' src="<?php echo $img_path; ?>img_event_promotion/<?php echo $images; ?>">
							...
							<td><?php
                                    ...
                                    ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['e_pro_id'];?>" class="btn btn-xs  btn-success">Edit</a>
