                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
									<?php
										$query="SELECT * FROM tbl_repair INNER JOIN tbl_vendor ON tbl_vendor.vendor_id=tbl_repair.vender_id WHERE status_report='2' ORDER BY report_id DESC LIMIT 150";
