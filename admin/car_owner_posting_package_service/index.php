  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CAR OWNER POSTING PACKAGE SERVICE CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Car Owner Posting Package</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="caption font-dark">
            <a href="add.php?services=<?=$services?>"" id="sample_editable_1_new" class="btn btn-info"> Add New
        ...
        <div class="tools"> </div>
			  ...
			  <?php   $v_sql1 = "SELECT *  FROM tbl_posting_package where group_id=".$services;
				...
				<h5 class="bg-primary text-dark p-2 mt-2"><caption class="caption-basicnew"><?=$row1['package_name']?> </caption></h5>
				...
				$result = $connect->query($v_sql);
                    ...
                    ?>
						  ...
						  ?>		</td>
                              ...
                              <td><a href="edit.php?edit_id=<?php echo $row['p_id'];?>&services=<?=$services?>" class="btn btn-xs  btn-success">Edit</a>
