            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label >Map Url</label>                   
					  <textarea  class="form-control" name="txt_map_url" cols="5" rows="5"><?php echo $map_url; ?>
                                    </textarea>
                  </div>                 
               ...
               <div class="form-group">
                    ...
                    <textarea class="textarea"  placeholder=""
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_infor"><?php echo $description; ?></textarea>
                  </div>

 <div class="form-group">
                    <label>Description(KH):</label>
                    <textarea class="textarea"  placeholder=""
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_infor_kh"><?php echo $description_kh; ?></textarea>
                  </div>
