  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CONTACT INFORMATION CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
...
<?php  $images=$row["pre_image"]; ?>
                             <tr>
                              ...
                              <td><?php echo $row["description_kh"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['c_id'];?>" class="btn btn-xs  btn-success">Edit</a> 
                            </td>
                            </tr>
