  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1> DRIVER RENTAL LIST AGREEMENT CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Driver Rental List </li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
...
<?php  $images=$row["pre_image"]; ?>
                        ...
                        <td><a href="edit.php?edit_id=<?php echo $row['ag_id'];?>" class="btn btn-xs  btn-success">Edit</a></td>
