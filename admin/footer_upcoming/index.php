  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>UPCOMING EVENTS CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { ?>
                             ...
                             <tr>
                              <td> <?php echo $row["ft_title"]; ?></td>
                              <td><?php echo $row["ft_detail"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['ft_id'];?>" class="btn btn-success">Edit</a></td>
                            </tr>
