            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label >Questions (En):</label>
                    <input type="text" class="form-control" name="txt_q" value="<?php echo $question; ?>"  required >
                  </div>
                   <div class="form-group">
                    <label >Questions (Kh):</label>
                    <input type="text" class="form-control" name="txt_q_kh" value="<?php echo $question_kh; ?>"   >
                  </div>

                   <div class="form-group">
                    <label >Answers (En):</label>
                   <textarea class="textarea"  placeholder=""
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_an"><?php echo $answer; ?></textarea>
					</textarea>
                  </div>            

				  <div class="form-group">
                    <label>Answers (Kh):</label>
                    <textarea class="textarea"  placeholder=""
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_an_kh"><?php echo $answer_kh; ?></textarea>
                  </div>
				  <div class="form-group">
                    <label >Order :</label>
