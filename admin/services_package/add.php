...
<?php 
 ...
 ?>
            ...
            <h1>Create Service Package Record</h1>
          </div>
            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
				   ...
				   <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="package_name" placeholder="Enter Name" value="<?php echo $package_name; ?>"   >
                  </div> 

				<div class="form-group">
                    <label>Description:</label>
                    <textarea class="textarea"  placeholder=""
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="package_disc"><?php echo $package_disc; ?></textarea>
                  </div>
