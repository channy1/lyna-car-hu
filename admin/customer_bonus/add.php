...
<?php
 ...
 ?>
            ...
            <h1> Create Customer Bonus Record</h1>
          </div>
            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_amount" placeholder="Enter Title"   required >
                  </div>

                  <div class="form-group">
                    <label >Bonus Amount</label>
                    <input type="text" class="form-control" name="txt_bonus_amount" placeholder="Enter Title"   required >
                  </div>
				</div>
