...
<?php 
 ...
 ?>
            ...
            <h1>Create Recent Post Record</h1>
          </div>
            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_title_kh" placeholder="Enter Title"   required >
                  </div>
 ...
 <div class="form-group">
               ...
               <div class="form-group">
                    ...
                    <textarea class="textarea"  placeholder="Enter Description"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_description" required="required"></textarea>
                  </div>

                  <div class="form-group">
                    <label>Detail (Kh):</label>
                    <textarea class="textarea"  placeholder="Enter Description"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_description_kh" required="required"></textarea>
                  </div>
 </div>
