                  ...
                  <tbody>
                    <?php 
                     if ($result->num_rows > 0) {
						...
						$delete_url="dalete.php?delete_id=".$row['pv_id']; ?>
						

                             <tr>
                              <td> <?php echo $row["pv_title"]; ?></td>
							 
                              <td><img style="height:50px; width:50px;" src="<?php  echo $img_path.'province/'. $row['pv_image'];?>"></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['pv_id'];?>" class="btn btn-success">Edit</a>
