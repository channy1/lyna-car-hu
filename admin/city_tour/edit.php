...
<?php 
    ...
    if(isset($_POST['btn_save'])){
            ...
            if($connect->query($query_add)==TRUE){
                ...
                $sms = '<div class="alert alert-success  col-md-12" >
            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
				  ...
				  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_title_kh" value="<?php echo $title; ?>"  required >
                  </div>
				  <div class="form-group">
                    <label >Image:</label>
					 <img style="height:50px; width:50px;" src="<?php  echo $img_path.'province/'.$image;?>">
                    <input type="file" class="form-control" name="txt_image" value="<?php echo $image; ?>"  required >
                  </div>
