  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>JOB SEEKERS CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          $delete_url="dalete.php?delete_id=".$row['ann_id'];
                          ?>
 
                             <tr>
                              <td> <?php echo $row["ann_title_en"]; ?></td>
                              <td> <?php echo $row["ann_salary"]; ?></td>
                              <td> <?php echo $row["ann_hiring"]; ?></td>
                              <td> <?php echo $row["ann_term"]; ?></td>
                              <td> <?php echo $row["ann_closing_date"]; ?></td>
                                
                            
                              <td><a href="edit.php?edit_id=<?php echo $row['ann_id'];?>" class="btn btn-xs  btn-success">Edit</a>
