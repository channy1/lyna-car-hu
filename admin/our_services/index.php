  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>OUR SERVICES CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          ...
                          $images=$row["se_image"]; ?>
                             <tr>
                              <td> <?php echo $row["se_title"]; ?></td>
                               <td> 

                             <img  width='100px' height='100px' src="<?php echo $img_path; ?>our_service/<?php echo $images; ?>">

                             <!--    <img width='100px' height='100px' src="../image/pre_info/<?php echo $row["pre_image"]; ?> > -->
                              </td>
                              <td><?php echo $row["se_detail"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['se_id'];?>" class="btn btn-xs  btn-success">Edit</a>
...
<script>
  ...
  function delete_data(url){
    swal({
  title: "Are you sure?",
  text: "Once deleted, you will not be able to recover this service detail",
  icon: "warning",
  buttons: true,
  dangerMode: true,
})
.then((willDelete) => {
 ...
 window.location.href = url;
    ...
    swal("Your service detail is safe!");
  }
});
}
