  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>OWNER OF THE VEHICAL AGREEMENT LIST CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Owner OF The Vehical Agreement List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
							...
							$delete_url="dalete.php?delete_id=".$row['ow_id'];
					?> 
                             <tr>
                              <td> <?php echo $i; ?></td>
                               
                              <td><?php echo $row["ow_name"]; ?></td>
                              <td><?php echo $row["ow_note"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['ow_id'];?>" class="btn btn-xs  btn-success">Edit</a>
