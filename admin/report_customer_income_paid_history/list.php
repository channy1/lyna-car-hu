...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6"> 
					<h1>CUSTOMER INCOME & PAID HISTORY LIST</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Home</a></li>
                        <li class="breadcrumb-item active">CUSTOMER INCOME & PAID HISTORY LIST</li>
                    </ol>
                </div>
            </div>
        </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
								<?php
								$query="SELECT * FROM tbl_rental_report INNER JOIN tbl_users ON tbl_users.user_id=tbl_rental_report.customer_id WHERE status_type='1' ORDER BY start_date DESC LIMIT 150";
