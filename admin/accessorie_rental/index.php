  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>ACCESSORIES RENTAL CONTROL PANEL</h1>
			<a href="add.php" class="btn btn-success">Add New <i class="fa fa-plus"></i></a>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Accessories Rental</li>
                  ...
                  <tbody>
                    <?php 
                     if ($result->num_rows > 0) {
						...
						$delete_url="dalete.php?delete_id=".$row['ac_id'];?>

                             <tr>
                              <td> <?php echo $row["ac_title"]; ?></td>
							 
                              <td><img style="height:50px; width:50px;" src="<?php  echo $img_path.'accessories rental/'. $row['ac_image'];?>"></td>
							  <td> <?php echo $row["ac_ref_no"]; ?></td>
							  <td> <?php echo $row["ac_days(1-7)"]; ?></td>
							  <td> <?php echo $row["ac_extradays(1-7)"]; ?></td>
							  <td> <?php echo $row["ac_days(15-26)"]; ?></td>
							  <td> <?php echo $row["ac_extradays(15-26)"]; ?></td>
							  <td> <?php echo $row["ac_monthly"]; ?></td>
							  <td> <?php echo $row["ac_extramonthly"]; ?></td>
							  <td> <?php echo $row["ac_yearly"]; ?></td>
							  <td> <?php echo $row["ac_extrayearly"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['ac_id'];?>" class="btn btn-success">Edit</a>
