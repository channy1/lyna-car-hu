...
<?php 
 ...
 ?>
            ...
            <h1>CREATE OUR CUSTOMER RECORD </h1>
          </div>
          ...
          <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
                ...
                <div class="card-body">
				  ...
				  <div class="form-group">
                    <label >Image:</label>
                    <input type="file" class="form-control" name="txt_image" placeholder="Enter Title"   required >
                  </div>
				  <div class="form-group">
                    <label >Url:</label>
                    <input type="text" class="form-control" name="txt_url" placeholder="Enter Title"   required >
                  </div>
