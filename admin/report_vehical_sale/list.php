                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="example2" class="table table-bordered table-hover">
								...
								<tbody>
									<?php
										$query="SELECT * FROM tbl_sale_product_report INNER JOIN tbl_users ON tbl_users.user_id = tbl_sale_product_report.customer_id ORDER BY product_id DESC LIMIT 150";
