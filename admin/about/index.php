                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          $delete_url="dalete.php?delete_id=".$row['about_id'];
                          ?>
<?php  $images=$row["pre_image"]; ?>
                             <tr>
                              <td> <?php echo $row["about_title"]; ?></td>                               
                              <td><?php echo $row["about_text"]; ?></td>
                              <td><a href="edit.php?edit_id=<?php echo $row['about_id'];?>" class="btn btn-xs  btn-success">Edit</a> 
                            </td>
                            </tr>
