            ...
            <!-- /.card-header -->
               ...
               <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="textarea"  placeholder="Enter Description"
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" name="txt_detail_kh" required="required"></textarea>
                  </div>
 </div>
