                    ...
                    <?php 
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          ...
                          ?><?php  $images=$row["lg_image"]; ?>
                             <tr>                             
                               <td><img   src="<?php echo $img_path; ?>logo/<?php echo $images; ?>">
                             <!--    <img width='100px' height='100px' src="../image/pre_info/<?php// echo $row["pre_image"]; ?> > -->
                              </td>
                              <td><a href="edit.php?edit_id=<?php echo $row['lg_id'];?>" class="btn btn-xs  btn-success">Edit</a>
                            </td>
                            </tr>
