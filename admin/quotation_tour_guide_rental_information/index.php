  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>TOUR GUIDE RENTAL INFORMATION QUOTATION CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Tour Guide Rental Information Quotation</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="caption font-dark">
            <a href="add.php" id="sample_editable_1_new" class="btn btn-success"> Add New <i class="fa fa-plus"></i></a>
        </div>
        <div class="tools"> </div>
    </div>
                     ...
                     if ($result->num_rows > 0) {
                        ...
                        while($row = $result->fetch_assoc()) { 
                          ...
                          ?>
                             ...
                             <tr>
                              <td> <?php    echo $row['user_first_name'].$row['user_last_name'];
 ?></td>
