  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>CAR RENTAL AGREEMENT LIST CONTROL PANEL</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Car Rental Agreement List</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody><?php 
                     ...
                     ?> 
                             <tr>
                              ...
                              <td> <a target="_blank" href="print.php?id=<?php echo $row['ag_id']; ?>"><i class="fa fa-print fa-fw" aria-hidden="true"></i></a> </td>
                              <td> <a target="_blank" href="../../admin/return_receip_and_receip/make_receip.php?id=<?php echo $row['ag_id']; ?>"><i class="fa fa-plus fa-fw" aria-hidden="true"></i></a>
                            ...
                            <a target="_blank" href="../../admin/return_receip_and_receip/return_receip.php?id=<?php echo $row['ag_id']; ?>"><i class="fa fa-print fa-fw" aria-hidden="true"></i></a></td>
                            </tr>
