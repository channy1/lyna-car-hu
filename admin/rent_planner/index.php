  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <tr style="background-color: #A4509F;color: white;text-transform: uppercase;">
                    <th style="text-align: left;">Accessories Rental</th>
                    <?php
                      for ($i=1; $i <=31 ; $i++) { 
    ...
    border-right: none;background-color:<?php echo $bg_color; ?>">
	  ...
	  <!---- City Tour ----->
	  		...
	  		<tr style="background-color:#A4509F; color:white; text-transform:uppercase;">
						<th style="text-align: left;">City Tour ( Country Wide )</th>
						<?php for ($i=1; $i <=31 ; $i++) { ?>                    
						<th></th>
						<?php } ?>
					</tr>
				<?php
					...
					<!------Hotel and Guesthouse ---->
					 ...
					 <tr style="background-color: #A4509F;color: white;text-transform: uppercase;">
                    <th style="text-align: left;">Hotel & Guesthouse </th>
                    <?php
                      for ($i=1; $i <=31 ; $i++) { 
    ...
    border-right: none;background-color:<?php echo $bg_color; ?>">
					...
					<!------End Hotel and Guesthouse--->
					
					<!-- PICKUP & DROP-OFF -->

        <tr style="background-color: #A4509F;color: white;text-transform: uppercase;">
                    <th style="text-align: left;">PICKUP & DROP-OFF</th>
                    <?php
                      for ($i=1; $i <=31 ; $i++) { 
    ...
    border-right: none;background-color:<?php echo $bg_color; ?>">
      ...
      <!-- end of Pickup & Drop-off -->
	  	...
	  	<!----- Airport Transfer --->
					...
					<!--- end of Airport Transfer --->
					
						<!---- Tour Guide rental----->
					
					<tr style="background-color:#A4509F; color:white; text-transform:uppercase;">
						<th style="text-align: left;">Tour Guide Rental</th>
						<?php for ($i=1; $i <=31 ; $i++) { ?>                    
						<th></th>
						<?php } ?>
					</tr>
				<?php
					...
					<?php } } ?>
					<!--- End of Tour Guide Rental ----->
						
						<tr style="background-color:#A4509F; color:white; text-transform:uppercase;">
							<th style="text-align: left;">DRIVER RENTAL</th>
							<?php for ($i=1; $i <=31 ; $i++) { ?>
								<th></th>
							<?php } ?>
						</tr>
