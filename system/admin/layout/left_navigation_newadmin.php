        ...
        <ul class="page-sidebar-menu   " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
            ...
            <a style="background-color: #a4509f; color: #a4509f; font-size: 11px;" href="#home" class="list-group-item" data-toggle="collapse" data-parent="#main-menu"><font style="color:white !important;">HOME</font><span class="caret"></span></a>
                ...
                <div class="collapse list-group-level1" id="home">
				 ...
				 <a href="../website_info/" class="list-group-item"><font class="tt zz">WEBSITE INFO</font></a>
                    ...
                    <a href="../event_promotion/" class="list-group-item"><font class="tt zz">EVENT</font></a>
                    <a href="../promotion/" class="list-group-item"><font class="tt zz">PROMOTION</font></a>
                    
                    <a href="../info_center/" class="list-group-item"><font class="tt zz">INFO CENTER NEWS</font></a>
                    <a href="../recent_post/" class="list-group-item"><font class="tt zz">RECENT POSTS</font></a>
                    ...
                    <a href="../contact_information/" class="list-group-item"><font class="tt zz">CONTACT</font></a>
...
?>
 <a style="background-color: #a4509f; color: #a4509f; font-size: 11px;" href="#PACKAGES" class="list-group-item" data-toggle="collapse" data-parent="#main-menu"><font style="color:white !important;">SYSTEM PACKAGES </font><span class="caret"></span></a>
                ...
                <div class="collapse list-group-level1" id="PACKAGES">
				  <a href="../admin_package/usergroup.php" class="list-group-item" style="background: #e0dfdf;" data-parent="#01"><font class="tt zz">USER GROUP</font></a>
				    <a href="../admin_package/membership.php" class="list-group-item" style="background: #e0dfdf;" data-parent="#01"><font class="tt zz">MEMBERSHIP PACKAGES</font></a>
				  <a href="../admin_package/services.php" class="list-group-item" style="background: #e0dfdf;" data-parent="#01"><font class="tt zz">SERVICE PACKAGES</font></a>
						 <?php   $v_sql = "SELECT *  FROM tbl_usergroup ";
                        $result = $connect->query($v_sql);
                      
                        if ($result->num_rows > 0) {                              $i=1;
                             
                            while($row = $result->fetch_assoc()){ ?>
							 <a href="../admin_package/index.php?services=<?php echo $row['id']; ?>" class="list-group-item" style="background: #e0dfdf;" data-parent="#02"><font class="tt zz"><?php echo $row['group_name']; ?> - POSTING PACKAGE SERVICE</font></a>
