...
if($rows->pakage_page=="1") {
?>
 <a style="background-color: #a4509f; color: #a4509f; font-size: 11px;" href="#MPACKAGES" class="list-group-item" data-toggle="collapse" data-parent="#main-menu"><font style="color:white !important;">MEMBERSHIP PACKAGES </font><span class="caret"></span></a>


                <div class="collapse list-group-level1" id="MPACKAGES">
                   <a href="../member_package/" class="list-group-item" style="background: #e0dfdf;" data-parent="#01"><font class="tt zz">MEMBERSHIP</font></a>
                </div>
    <?php
      }
    ?>
