     ...
     if(isset($_POST['btn_save'])){
        /* $v_image = @$_FILES['txt_image'];
            if($v_image["name"] != ""){
                ...
                move_uploaded_file($v_image["tmp_name"], "../image/promotion/".$new_name);
            }else{
                $new_name = $image;
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                ...
                <b style="font-size: 15px;">​​​​​​EDIT Promotion</b><br><br>
                        ...
                        <div class="row">						
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">                                
								<div class="form-group form-md-line-input">                                	 
									<label style="color: white; font-size: 15px;" class="col-xs-6 col-sm-3 col-md-3 col-lg-2">Redirect Url                                        
										<span class="required" aria-required="true">*</span>                                    
									</label>                                    
									<span class="help-block">Redirect Url</span>                                  
									<div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">                                      
										<input type="text" class="form-control" name="redirect_url" placeholder="Redirect URL"  autocomplete="off" required style="background-color: white;" value="<?php echo ($redirect_url); ?>">                                  
									</div>   
									<div class="col-xs-2 col-sm-1 col-lg-2">
										<img src="../image/promotion/<?php echo ($image); ?>" alt="Promotion Images" style="width:100%;height:100%;border:1px solid black; border-radius:5px !important ;">
									</div>
								</div>                            
							</div>	
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea style="height: 150px;background-color: white;padding: 10px;" class="form-control " name="txt_promotion" placeholder=""  autocomplete="off"><?php echo ($e_promotion); ?></textarea>
                                    <label style="color: white;font-size: 15px; ">Promotion (En)
                                        <span class="required" aria-required="true">*</span>
                                    </label>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea style="height: 150px;background-color: white;padding: 10px;" class="form-control "  name="txt_promotion_kh" placeholder=""  autocomplete="off"><?php echo ($e_promotion_kh); ?></textarea>
                                    <label style="color: white;font-size: 15px; ">Promotion (Kh)
                                        <span class="required" aria-required="true">*</span>
                                    </label>
