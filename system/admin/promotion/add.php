...
<?php 
  if(isset($_POST['btn_add'])){
           ...
           /* if($v_image["name"] != ""){
             ...
             $v_image1 = $new_name;
            $query_add = "INSERT INTO tbl_promotion(
                     `promotion`,
                     `promotion_kh`,
                     `images`,
                     `redirect_url`,
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-plus-circle fa-fw"></i>Add Promotion</h2>
        </div>
    </div>
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                ...
                <b style="font-size: 15px;">​​​​​​ADD Promotion</b><br><br>
                             ...
                             <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-5">  
                                    <input type="url" class="form-control" name="redirect_url" placeholder="Redirect Url"  autocomplete="off" required style="background-color: white;">
                                  </div> 
                                </div>
                            </div>														
                          ...
                          <!--  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                               <div class="form-group form-md-line-input">
                                  ...
                                  <div class="col-xs-12 col-sm-12 col-md-12 col-lg-3">  
                                    <input type="file" class="form-control" name="txt_image"  required autocomplete="off" style="background-color: white;">
                                  </div>
                                </div>
                            </div>-->
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea style="height: 150px;background-color: white;padding: 10px;" class="form-control "  name="txt_promotion" placeholder=""  autocomplete="off" required></textarea>
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <textarea style="height: 150px;background-color: white;padding: 10px;" class="form-control"  name="txt_promotion_kh" placeholder=""  autocomplete="off"></textarea>
