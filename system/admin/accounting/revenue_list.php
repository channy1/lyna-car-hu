...
<?php
  ...
  if(isset($_POST["btnadd"])){
    ...
    $result = mysqli_query($connect, $sql);
    header("location:revenue_list.php?message=delete");  
} 
?>
            ...
            <div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="text-primary">Revenue List <select onchange="window.location=this.value"><option value="revenue_list.php">Rent</option><option selected value="revenue_list.php">Input</option></select></h2>
                        <hr>
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          <tr>
                                            ...
                                            <td><?php echo $v7;?></td>
                                            <td align = "center">
                                            <a href="edit_revenue_list.php?id=<?php echo $row['rev_id']; ?>" class="btn btn-primary btn-xs"><i class="fa fa-edit"></i></a>
                                            <a onclick = "return confirm('Are you sure to delete ?');" href="revenue_list.php?id=<?php echo $row['rev_id']; ?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i></a>
                                            </td>
                                          </tr> 
                                          <?php
                                            }  
