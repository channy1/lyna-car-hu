...
<?php
  ...
  if(isset($_POST["btnadd"])){
    ...
    $v_note = $_POST["txt_note"];
     ...
     header('location:revenue_category.php?message=success');
 }
    if(isset($_GET["id"])){
    $id = $_GET["id"];
    ...
    $result = mysqli_query($connect, $sql);
    header("location:revenue_category.php?message=delete");  
} 
?>
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          <tr>
                                            ...
                                            <a onclick = "return confirm('Are you sure to delete ?');" href="revenue_category.php?id=<?php echo $row['reca_id']; ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                          </tr> 
                                          <?php
                                            }  
