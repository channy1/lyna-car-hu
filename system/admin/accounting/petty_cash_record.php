            ...
            <div class = "col-xs-12">
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel panel-default">
                        ...
                        <h2 class="text-primary">PETTY CASH RECORD <select onchange="window.location=this.value"><option value="petty_cash_deposit.php">Deposit</option><option selected="" value="petty_cash_record.php">Input</option></select></h2>
                        <hr>
                                    ...
                                    <tbody>
                                        <?php
                                          ...
                                          <tr>
                                            ...
                                            <td>$<?php echo number_format($row["ex_price"],2);?></td>
