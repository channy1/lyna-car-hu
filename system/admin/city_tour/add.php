...
<?php 
    if(isset($_POST['btn_add'])){
            ...
            if($v_image["name"] != ""){
               ...
               // move_uploaded_file($v_image["tmp_name"], "../image/province/".$new_name);				  move_uploaded_file($v_image["tmp_name"],$inner_directory_path ."province/".$new_name);
            }else{
                $new_name = "blank.png";
            }
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
      ...
      <div class="col-md-9 col-xs-12 mobile_fonts"> 
          <center>
                <h3><b style=";font-family: Khmer OS Muol; ">បញ្ចូលខេត្ត </b></h3>
                <b style="font-size: 20px;">​​​​​ADD PROVINE</b><br><br>
