...
<?php
   $edit_id = $_GET["edit_id"]; 
    $query="SELECT * FROM tbl_posting_package WHERE id='$edit_id'";
...
<?php 
    ...
    if(isset($_POST['btn_add'])){
            ...
            $package_name = @$connect->real_escape_string($_POST['package_name']);   
            $query_add = "UPDATE tbl_posting_package SET 
            group_id='$group_id',
...
<div class="portlet light bordered">
    ...
    <div class="portlet-title">
        <div class="caption font-dark">
            <a href="services.php" id="sample_editable_1_new" class="btn red"> 
						...
						<?php } } ?>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <input type="text" class="form-control" name="package_name" placeholder="Enter Name" value="<?php echo $package_name; ?>"  autocomplete="off" style="background-color:white;" required>
                                  </div>
                                </div>
                            </div>
                           ...
                           <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                        <textarea id="detail" name="package_disc" class="detail"> <?php echo $package_disc; ?></textarea>
