...
<?php 
    if(isset($_POST['btn_add'])){
            ...
            $query_add = "INSERT INTO tbl_posting_package (
                    group_id,
                    package_name,					
                    package_disc                   
                    ) 
...
<div class="portlet light bordered">
    <div class="row">
        <div class="col-xs-12">
            <?= @$sms ?>
            <h2><i class="fa fa-plus-circle fa-fw"></i>Add Record</h2>
        </div>
    </div>
						...
						<?php } } ?>
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                                <div class="form-group form-md-line-input">
                                    ...
                                    <input type="text" class="form-control" name="package_name" placeholder="Enter Name"  autocomplete="off" style="background-color:white;" required>
                                  </div>
                                </div>
                            </div>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-5 text-center">
                                ...
                                <a href="service.php" class="btn red"><i class="fa fa-undo fa-fw"></i>Cancel</a>
                            </div>
                        </div>
                    </div>
                </form><br>
