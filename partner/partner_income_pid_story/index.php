						...
						<div class="card-body p-0">   
							<div class="row">
								...
								<div class="col-md-4 p-0">
									<a target="_blank" class="btn btn-danger" href="print.php?txt_month=<?php echo $s_input_month; ?>&txt_year=<?php echo $s_input_year; ?>&pre_by=<?php echo $pre; ?>&app_by=<?php echo $app; ?>"><i class="fa fa-print"></i> Print</a>
								</div>
							</div>          
						</div>
					</form>
					<table id="example2" class="table table-bordered table-hover">
						...
						<tbody>
							<?php
								...
								$query="SELECT * FROM tbl_partner_income_paid_history LEFT JOIN tbl_users
