...
if(isset($_POST['btn_tour_home'])) {
 $_SESSION['pickup_map_location']=@$connect->real_escape_string($_POST['pickup_map_location']);
 $_SESSION['return_map_location']=@$connect->real_escape_string($_POST['return_map_location']);
 $_SESSION['citytour_comment']=@$connect->real_escape_string($_POST['citytour_comment']);
 $_SESSION['province_id']=@$connect->real_escape_string($_POST['province_id']);
}

if(isset($_POST['btn_drive'])) {
...
<?php
   ...
   if(isset($_POST['btn_interest']) ) {
       ...
       $_SESSION["pickup_date"]=@$connect->real_escape_string($_POST['pickup_date']);
   $_SESSION["pickup_time"]=@$connect->real_escape_string($_POST['pickup_time']);
   $_SESSION["return_date"]=@$connect->real_escape_string($_POST['return_date']);
   $_SESSION["return_time"]=@$connect->real_escape_string($_POST['return_time']);
   $_SESSION['province_id']=@$connect->real_escape_string($_POST['province_id']);


   }

   if(isset($_POST['btn_check_interest'])) {
    $_SESSION['place_id']=@$connect->real_escape_string($_POST['identity_interest']);
   }
   ...
   ?>
   <?php
   if(isset($_POST['btn_place']) ) {
   $_SESSION["txt_city_parent"]=@$connect->real_escape_string($_POST['txt_city_parent']);
   $_SESSION["identity_equipment"]=@$connect->real_escape_string($_POST['identity_equipment']);
   ...
   <div class="panel panel-default">
      <div  class="panel-heading">
         <h4 class="head-form"><i class="fa fa-handshake-o" aria-hidden="true"></i>
            &nbsp;SEARCH FOR INTEREST PLACE BOOKING
         </h4>
      </div>
      <div class="row">
         <div class="col-md-8">
       ...
       <li <?php if(empty($post_step)){echo "class='active'";} ?>>
                           <a class="nav-link" data-toggle="tab" href="#one">Select Date</a>
                        </li>
                         <li <?php if($post_step=="1"){ echo "class='active'"; }?>>
                           <a class="nav-link" id="two-tab" data-toggle="tab" href="#two" role="tab" aria-controls="Two"
                           aria-selected="false">Interest Place</a>
                        </li>

                        <li <?php if($post_step=="2"){ echo "class='acReservation Informationtive'"; }?>>
                           <a class="nav-link" data-toggle="tab" href="#three">Service</a>
                        </li>
                        <li <?php if($post_step=="3"){ echo "class='active'"; }?>>
                           <a class="nav-link" data-toggle="tab" href="#four">Personal Info</a>
                        </li>
                        </li>
                        <li <?php if($post_step=="4"){ echo "class='active'"; }?>>
                           <a class="nav-link" data-toggle="tab" href="#five">Confirm Booking</a>
                        </li>
        </ul>
                    ...
                    <form action="city_booking.php" method="POST" class="booking-form">
                                            <div class="row">
    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
     ...
     <option data-display="Vehicle Type">Select Vehicle Type</option>
      ...
      <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    <p>
                                                        <button name="btn_car_rent" type="submit" class="gauto-theme-btn">Find City Tours</button>
                                                    </p>
                                                </div>
                                            </div>
                  ...
                  <form method="post" action="city_booking.php" id="form_interest" class="booking-form">
                  <input type="hidden" name="post_step" value="2">
                  <button style="margin-top: 10px;" class="btn btn-success" name="btn_check_interest" type="submit">Continue</button>
                  <label id="alert_interest"></label>
                   <?php                    $inter_id=$_SESSION['province_id'];
                                            $v_sql = "SELECT * FROM tbl_province_detail AS A LEFT JOIN tbl_province AS B ON B.pv_id=A.pl_pro_id WHERE pv_id='$inter_id' order by pv_title
                                            ";
              ...
              <div class="row" style="border: 2px solid #ccc;border-radius: 5px;width: 99%;padding: 17px;margin-left: 1px;margin-top: 10px;margin-bottom: 5px;">
                  ...
                  <div class="col-md-6">
                      <ul>
                          <li style="list-style: none;margin-bottom: -3px !important;">
                              <label>Place Name :<span><?php echo $row['pl_title']; ?></span></label>
                          </li>
                          <li style="list-style: none;margin-bottom: -3px !important;">
                              <label>Price :<span>$ <?php echo number_format($row['pl_price'],2); ?></span></label>
                          </li>
                          <li style="list-style: none;margin-bottom: -3px !important;">
                              <label>Province :<span><?php echo $row['pv_title']; ?></span></label>
                          </li>
                           <li style="list-style: none;margin-bottom: -3px !important;">
                              <label>Distance From City :<span><?php echo $row['pl_distance']; ?></span></label>
                          </li>
                  ...
                  <div class="col-md-3">
                     ...
                     <input  type="checkbox" name="tick" class="checkbox input-checkbox" onclick="addinterest(<?php echo $row['pl_id'];?>)" id="addinterest_<?php echo $row['pl_id'];?>" style="float: right;">
                                       <br>
                                       <span>Qantity :</span>
                                       <input class="form-control" readonly type="text"  name="qty_interest_<?php echo $row['pl_id'];?>" value="" id="number_interest_<?php echo $row['pl_id'];?>">

                  </div>
              </div>
          <?php }} ?>
            <input type="hidden" name="identity_interest" id="identity_interest"/>

              <script type="text/javascript">
                                      function addinterest(index){

                                       var id=$('#identity_interest').val();
                                       var arrays = id.split(',');
                                       for(var j=0;j<arrays.length;j++) {//calculate record row
                                         if(arrays[j] == index) arrays.splice(j,1);
                                         if(document.getElementById('addinterest_'+index).checked){
                                           if(($("#identity_interest").val())!="") {
                                             $("#identity_interest").val(id+','+index);
                                           }else {
                                             $("#identity_interest").val(index);
                                           }
                                          // $("#number_equipment_"+index).removeAttr("readonly");
                                           $("#number_interest_"+index).val(1);
                                          }else{
                                            //alert(index);
                                           var strings = arrays.join(',');
                                           $('#identity_interest').val(strings);
                                           $("#number_interest_"+index).val("");
                        ...
                        <div class="tab-pane <?php if($post_step=="2") {echo "active in";} ?>" <?php if($post_step=="2") { ?> id="three" <?php } ?>>
                        <form class="booking-form" method="post" action="city_booking.php" id="form_drive" <?php if($post_step !="2") { ?> style="display:none;" <?php } ?>>
                  <input type="hidden" name="post_step" value="3">
                      <div  class="card-header tab-card-header hiiden_tap_click_one" <?php if($post_step=="2") { ?> style="display:block;" <?php } else { ?> style="display:none;" <?php } ?>>
                               <ul class="nav nav-tabs card-header-tabs" id="myTab" role="tablist">
                                 <li id="tap_driver">
                                     <a  data-toggle="tab" href="#driver">Driver</a>
                                 </li>
                                  <li id="tap_car">
                                     <a  data-toggle="tab" href="#car">Vehicle Type & RickShaw</a>
                                 </li>
                                 <li id="tap_tour">
                     ...
                     <div class="tab-content" id="myTabContent">
                        <ul class="nav nav-tabs card-header-tabs display_hidden_rich_car" id="myTab" role="tablist">
                                 <li id="tap_vehicle">
                                     <a data-toggle="tab" href="#service_car">Vehicle Type</a>
                                 </li>
                                 <li id="tap_richshaw">
                                     <a data-toggle="tab" href="#service_rickshaw">RickShaw</a>
                                 </li>
                         </ul>
                         </div>
                         </form>
                          ...
                          <div class="tab-pane" id="service_car">
                                    <div class="tab-pane <?php if($post_step=="2") {echo "active in";} ?>"id="four" <?php if($post_step=="2") { ?> id="car" <?php } ?>>

                         <ul class="nav nav-tabs card-header-tabs product_book" id="myTab" role="tablist" style="display:block;">
                                 <?php
                                 $pro_picup_car=$_SESSION['province_id'];
                                 $sql ="SELECT *
                                        ...
                                        WHERE tbl_vehicle_rantal.status='1' AND (tbl_carrental_pickup_price.pro_from_id='$pro_picup_car' OR add_by_id='' ) GROUP BY ve_id";
                          ...
                          <div class="tab-pane" id="service_rickshaw">
                            <label id="alert_richshaw"></label>
                             <?php
                             $pro_id_rick=$_SESSION['province_id'];
                                 $sql ="SELECT * FROM tbl_rick_shaw_rental_last WHERE tbl_rick_shaw_rental_last.province_id='$pro_id_rick' AND status='1' ";
                                  $result = $connect->query($sql);
                      ...
                      <?php
                       ...
                       <input type="radio" name="check_option_drive" id="check_option_drive_rental" value="No">Chauffeur Rental
                       <button style="margin-top: 10px;" class="btn btn-success" name="btn_drive" type="submit">Continue</button>
                    <br>
                        <br>
                        <div id="check_drive"></div>
                         </div>
                        ...
                        <div class="tab-pane <?php if($post_step=="3") {echo "active in";} ?>" <?php if($post_step=="1") { ?> id="four" <?php } ?>>
                     <?php
                   ...
                   <div class="row">
                        ...
                        <div class="col-md-12">
                          ...
                          <form method="post" action="city_booking.php" class="booking-form">
                           <input type="hidden" name="post_step" value="3">
                            ...
                            <?php } else { ?>
                  <form  action="" method="post" id="agree_form">
...
<div class="my-dropdown make-dropdown">
  ...
  <button type="submit" id="c_agree" class="btn btn-primary" name="term_condiction">Continue</button>
                  ...
                  <div class="tab-pane <?php if($post_step=="4") {echo "active in";} ?>" <?php if($post_step=="4") { ?> id="five" <?php } ?>>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <?php
                                                         ...
                                                         $date1=date_create($_SESSION["pickup_date"]);
                                                         $date2=date_create($_SESSION["return_date"]);
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                      <?php
                                                           if(!isset($_SESSION["pickup_date"]))
                                                            {
                                                             echo $_SESSION["pickup_date"]="";
                                                            }
                                                            else {
                                                             echo $_SESSION["pickup_date"].' '.$_SESSION['pickup_time'];
                                                            }
                                                          ?>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                       <?php
                                                           if(!isset($_SESSION["return_date"]))
                                                            {
                                                             echo $_SESSION["return_date"]="";
                                                            }
                                                            else {
                                                             echo $_SESSION["return_date"].' '.$_SESSION['return_time'];
                                                            }
                                                          ?>
                              ...
                              <table style="border-collapse:collapse;font-size: 12px;margin-top:10px;float: left;" width="100%">
                                 <tbody><tr><td colspan="8" style="border-bottom:1px solid #ccc;text-align: left;background-color:  #7030A0;color:rgb(254, 250, 250);"><strong style="font-size:14px;">&nbsp;Item Information</strong></td></tr>
                                  <tr>
                                     ...
                                     <th style="background-color:#7030A0;color:white" colspan="4" width="10%" class="aa text-center">Price In US$</th>
                                  </tr>
                                  <tr style="text-align: center">
                                     <th style="background-color:#7030A0;color:white" class="aa text-center" width="10%">Price</th>
                                     <th style="background-color:#7030A0;color:white" class="aa text-center" width="10%">Discount</th>
                                     <th style="background-color:#7030A0;color:white" class="aa text-center" width="10%">VAT</th>
                                     <th style="background-color:#7030A0;color:white" class="aa text-center" width="10%" nowrap="nowrap">Amount</th>
                                  </tr>
                                      <?php
                                if(!isset($_SESSION["place_id"])) {
                                          $place_id="";
                                           $sql ="SELECT * FROM tbl_province_detail   WHERE pl_id=''";
                                          }
                                       else {
                                           $place_id=$_SESSION['place_id'];
                                            $sql ="SELECT * FROM tbl_province_detail  WHERE pl_id IN ($place_id)";
                                       }
                                        $result = $connect->query($sql);
                                        $i=1;
                                        $sub_total_place_price=0;
                                        $sub_pirce=0;
                                        $total_place_vat=0;
                                          $start_day=date_create($_SESSION["pickup_date"]);
                                                $end_day=date_create($_SESSION["return_date"]);
                                                $day=date_diff($start_day,$end_day);
                                                $total_day_mul = $day->format("%a%")+1;


                                         if ($result->num_rows > 0) {
                                          while($row = $result->fetch_assoc()){
                                            $price_place=$row['pl_price'] * $total_day_mul ;
                                            $sub_pirce +=$row['pl_price'];
                                            $sub_total_place_price +=$price_place;
                                ?>
                                   ...
                                   <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($row['pl_price'], 2); ?></td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000"><?= number_format(0, 2);?>%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000"><?= number_format(0, 2);?>%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php

                                          echo number_format($price_place, 2);
                                      ...
                                      ?>
                                         ...
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"></td>
                                          ...
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;">
                                            <?php
                                              $check_i_disount=$i-1;
                                              if($check_i_disount>1 && $check_i_disount<4){
                                                $discount_plce=0;
                                              }
                                              elseif ($check_i_disount>=4 && $check_i_disount<8) {
                                               $discount_plce=5;
                                              }
                                              elseif ($check_i_disount>=8 && $check_i_disount<12) {
                                               $discount_plce=10;
                                              }
                                              elseif ($check_i_disount>=12 && $check_i_disount<16) {
                                               $discount_plce=15;
                                              }
                                              elseif ($check_i_disount>=16 && $check_i_disount<20) {
                                               $discount_plce=20;
                                              }
                                              else {
                                                $discount_plce=25;
                                            ...
                                            ?>
                                            <?php
                                              echo number_format($discount_plce,2);
                                            ?>%
                                          </td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;"><?php echo number_format(10,2)?>%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;">$<?php

                                          $plce_total_discount=($sub_total_place_price)-($sub_total_place_price * $discount_plce)/100;
                                           $total_place_vat=$plce_total_discount+($plce_total_discount * 10)/100;
                                 ...
                                 <tr style="height:25px;border:1px!important">
                                          ...
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;"><?php echo number_format($row['discount'], 2); ?>%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;"><?php echo  number_format($row['vat'], 2);?>%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;">
                                             <?php
                                   ...
                                   <?php
                                      ...
                                      <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($extraday_price/$extraday, 2); ?></td>
                                  ...
                                  ?>
                                   <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($check_price_pick, 2); ?></td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">0%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000"><?php echo number_format($row['vat_carren'], 2); ?>%</td>
                           ...
                           <?php }} ?>
                                    ...
                                    <?php
                                       ...
                                       <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($daily_price/$total_day_daily, 2); ?></td>
                                      ...
                                      <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($extraday_price/$total_extraday, 2); ?></td>
                                      ...
                                      <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$<?php  echo number_format($holiday_price/$total_holiday, 2); ?></td>
                                 ...
                                 <tr style="height:25px;border:1px!important">
                                          ...
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000"><?php echo number_format($row['discount'], 2); ?>%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000"><?php echo number_format($row['vat'], 2); ?>%</td>
                                          <td align="right" style="background:#ffffff;width:10%;border:1px solid #000000;padding-left:8px;" nowrap="">
                                             <?php
                            ...
                            <?php
                                       ...
                                       <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"><?php echo $i++; ?></td>
                                          ...
                                          <td align="right" style="background:#ffffff;width:10%;border:1px solid #000000;padding-left:8px;" nowrap="">$<?php
                                      ...
                                      <td align="right" style="background:#ffffff;border:1px solid #000000;" nowrap="">$<?php $total_rental=$amount_rickshaw+$amount_accessory+$amount_tour+$amount_drive +$amount_car+$total_place_vat; echo number_format($total_rental, 2);  ?> </td>
                                  ...
                                  <tr>
                                      ...
                                      <td align="right" style="font-weight:bold;background:blue;border:1px solid #000000;color:white;" nowrap="">$<?php echo $_SESSION['total_amount']=number_format($total_service_char + $total_rental, 2); ?></td>
                                  </tr>
                                   <?php
                                   if(!isset($_SESSION["car_id"])) {
                                           $car_id="";
                                  ...
                                  <tr>
                                      ...
                                      <td align="right" style="border:1px solid #000000;" nowrap="">$<?php echo
                                      number_format($ld_price, 2);  ?></td>
                                  </tr>
                                 ...
                                 <?php
                                  ...
                                  ?>
                                    <tr>
                                      ...
                                      <td align="right" style="border:1px solid #000000;" nowrap="">$<?php echo number_format($deposit_off, 2); ?>
                                       </td>
                                  </tr>
                                  <tr>
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;6. Due Amount <span style="color:red;">**</span>:</td>
                                      <td align="right" style="font-weight:bold;background:blue;border:1px solid #000000;color:white;" nowrap="">$<?php echo  number_format($ld_price+$deposit_off, 2); ?></td>
                                  </tr>
         ...
         <div id="aba_main_modal" class="aba-modal">
            ...
            <div class="aba-modal-content">
               ...
               <form method="POST" target="aba_webservice" action="<?php echo PayWayApiCheckout::getApiUrl(); ?>" id="aba_merchant_request">
                <?php
                     ...
                     $continue_success_url ='http://'.$_SERVER['SERVER_NAME'].'/'.'lyna-CarRental/city_booking.php?tranid='.$transactionId;
                  ...
                  $p_date=$_SESSION["pickup_date"];
                  $re_date=$_SESSION["return_date"];
                  $pickup_time=$_SESSION['pickup_time'];
                  $return_time=$_SESSION['return_time'];
                  $amount_web_pay=$total_service_char + $total_rental;
                  $today = date("Y-m-d");
                  $pickup_map=$_SESSION['pickup_map_location'];
                  $return_map=$_SESSION['return_map_location'];
                  $comment_city=$_SESSION['citytour_comment'];
                 ...
                 if( ($get_url_tran_id !="") && ($_SESSION["term_check_pay"]) !="" ) {
                  if($result['status'] ==0){
                       ...
                       while($row = $result->fetch_assoc()){
                        ...
                        $insert_daily_day=$total_day-$extraday;
                        $price_daily_car_insert=$day_price/($total_day-$extraday);
                        $price_extra_car_insert= $extraday_price/$extraday;
                               $sql_car = "INSERT INTO `tbl_book_car`(
                                 `book_infor_id`,
                                  `car_id`,
                                  `price`,
                                  `car_discount`,
                              ...
                              VALUES(
                                  ...
                                  '$insert_daily_day',
                                  '$extraday',
                                  '$price_daily_car_insert',
                                  '$price_extra_car_insert',
                                  '$check_price_pick',
                                  '$vat_pickup',
                                  '0'
            ...
            $a_id=$_SESSION['accessory_id'];
              ...
              $t_id=$_SESSION['tour_quide_id'];
               ...
               $pro_id=$_SESSION['place_id'];
               $sql ="SELECT * FROM tbl_province_detail  WHERE pl_id IN ($pro_id)";
               $result = $connect->query($sql);
                $sub_total_place_price=0;
                $sub_pirce=0;
                $total_place_vat=0;
               ...
               if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()){
                  $in_province_id=$row['pl_id'];
                  $price_place_insert=$row['pl_price'];
                  $price_place=$row['pl_price'] * $total_day_mul;
                  $sub_pirce +=$row['pl_price'];
                  $sub_total_place_price +=$price_place;
                        ...
                        $sql_province = "INSERT INTO `tbl_book_province`(
                            `book_info_id`,
                            `province_id`,
                            `pro_price`,
                            `pro_discount`,
        ...
        <td>
                  ...
                  <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial;font-size:12px">
                    <tbody>
                          ...
                          <table width="100%" align="left" border="0" cellspacing="0" cellpadding="0" style="font-family:Arial;font-size:12px">
                            <tbody><tr><td colspan="5"><center><h2>RESERVATION INVOICE</h2></center></td></tr><tr border="1" style="background:#dfdfdf">
                              ...
                              <tr border="1" style="background:#dfdfdf">
                                ...
                                <td width="25%" align="left">'.$_SESSION["pickup_date"].''.$_SESSION["pickup_time"].':'.$_SESSION["pickup_mins"].'</td>
                                <td width="5%"></td>
                                <td width="20%" align="left"></td>
                                <td width="30%" align="right"></td>
                              </tr>
                              <tr>
                                ...
                                <td width="25%" align="left">'.$_SESSION["return_date"].'.'.$_SESSION["return_time"].':'.$_SESSION["return_mins"].'</td>
                            ...
                            <tbody>
                              ...
                              if(!isset($_SESSION["place_id"])) {
                                      ...
                                      $htmlContent.=' <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($row['pl_price'], 2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format(0, 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format(0, 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($price_place, 2).'</td>
                                      </tr>';
                                    ...
                                    $htmlContent.='
                                         ...
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;"></td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000"></td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;">$'.number_format($sub_pirce,2).'</td>
                                          ...
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;">';
                                              ...
                                              $htmlContent.=''.number_format($discount_plce,2).'%</td>
                                              <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000;font-weight: 900;">'.number_format(10,2).'%</td>
                                          ...
                                          $htmlContent.=''.number_format($total_place_vat,2).'</td>';
                              ...
                              <td align="left" style="padding-left:8px;width:48%;border:1px solid #000000">'.$row["ve_title"].' '.$row["ve_year"].'</td>';
                                               ...
                                               $start_day=date_create($_SESSION["pickup_date"]);
                                                ...
                                                $day=date_diff($start_day,$end_day);
                                                $total_day = $day->format("%a%")+1;
                                                $total_dialy_car=$total_day-$extraday;
                                                $price_car_daily=$day_price/($total_day-$extraday);
                                                $extraday_price_car=$extraday_price/$extrada;


                           $htmlContent.='<td align="center" style="border:1px solid #000000;width:8%">'.$total_dialy_car.' Day(s)</td>
                              <td align="center" style="border:1px solid #000000;width:5%">1</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($price_car_daily, 2).'</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['discount'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['vat'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($price_item_car_daily, 2).'</td>
                              </tr>';
                      if($extraday>0) {
                          $htmlContent.='<tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($extraday_price_car, 2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['discount'] ,2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['vat'] ,2).'%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($price_item_car_extra, 2).'</td>
                                      </tr>';
                      }
                      ...
                      if($check_price_pick >0) {
                        $htmlContent.='<tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          <td align="left" style="padding-left:8px;width:48%;border:1px solid #000000">&nbsp;&nbsp;&#126;&nbsp;Pickup From&nbsp;&nbsp;'.$pick_from_location.'&nbsp; & Return &nbsp;'.$return_to_location.'</td>
                                          <td align="center" style="padding-left:8px;width:8%;border:1px solid #000000"></td>
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($check_price_pick, 2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format(0, 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format(0, 2).'%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($total_pick_vat, 2).'</td>
                                      </tr>';
         ...
         if(!isset($_SESSION["richshaw_id"])) {
            ...
            $htmlContent.='<tr style="height:25px;border:1px!important">
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          <td align="left" style="padding-left:8px;width:48%;border:1px solid #000000">'.$row['ve_title'].' '.$row['ve_ref_no'].'</td>
                                          <td align="center" style="padding-left:8px;width:8%;border:1px solid #000000">
                                            '.$total_day.' Day(s)
                                          </td>
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($price_rent, 2).'
                                          </td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['discount'], 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['vat'], 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($total_rich, 2).'
                        ...
                        if(!isset($_SESSION["accessory_id"])) {
                              ...
                              <td align="left" style="padding-left:8px;width:48%;border:1px solid #000000">'.$row["ac_title"].' '.$row["ac_ref_no"].'</td>';
                                               ...
                                               $start_day=date_create($_SESSION["pickup_date"]);
                                                ...
                                                $day=date_diff($start_day,$end_day);
                                                $total_day = $day->format("%a%")+1;
                                                $total_daily_acc=$total_day-$extraday;


                           $htmlContent.='<td align="center" style="border:1px solid #000000;width:8%">'.$total_daily_acc.' Day(s)</td>
                              <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($day_price/($total_day-$extraday), 2).'</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['discount'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['vat'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($price_item_accessory_daily, 2).'</td>
                              </tr>';
                               if($extraday>0) {
                           $htmlContent.='<tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:8%;border:1px solid #000000">'.$extraday.' Day(s)</td>
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($extraday_price/$extraday ,2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['discount'], 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['vat'], 2).'%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($price_item_accessory, 2).'</td>
                                      </tr>
                           ';
                               }
                         ...
                         $htmlContent.='<tr style="height:30px;border:1px solid #000000">
                           ...
                           $htmlContent.='<td align="center" style="border:1px solid #000000;width:8%">'.$total_day_daily.' Day(s)</td>
                              <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($daily_price/$total_day_daily, 2).'</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['discount'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">'.number_format($row['vat'], 2).'%</td>
                              <td align="right" style="border:1px solid #000000;width:10%;" nowrap="">$'.number_format($daily_price_item, 2).'</td>
                              </tr>';
                              if($total_extraday>0) {
                                $htmlContent.=' <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($extraday_price/$total_extraday, 2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['discount'], 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['vat'], 2).'%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($extraday_price_item, 2).'</td>
                                      </tr>';
                              }
                               if($total_holiday>0) {
                                $htmlContent.=' <tr style="height:25px;border:1px!important">
                                         <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000;">'.$i++.'</td>
                                          ...
                                          <td align="center" style="padding-left:8px;width:5%;border:1px solid #000000">1</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($holiday_price/$total_holiday, 2).'</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['discount'], 2).'%</td>
                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">'.number_format($row['vat'], 2).'%</td>

                                          <td align="right" style="padding-left:8px;width:10%;border:1px solid #000000">$'.number_format($holiday_price_item, 2).'</td>
                                      </tr>';
                               }
...
if($total_holiday>0) {
                           ...
                           $htmlContent.='<tr style="height:25px;border:0px!important">
                              ...
                              <span style="font-size:11px"><b style="color:red"><u>Note</u> *</b><br> 1. Long Distance Assistance Fee (LD Assistance) will be refunded 70%, if no problem with the rented car. </span><br>
                                      ...
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;1. Total Rental Fee:</td>';
                                       $total_rental=$amount_rickshaw+$amount_accessory+$amount_tour+$amount_drive +$amount_car+$total_place_vat;
                             $htmlContent.='<td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($total_rental, 2).'</td>
                              ...
                              $htmlContent.='<td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($total_service_char, 2).'</td>
                                    ...
                                    $htmlContent.='<tr style="height:25px;border:0px!important">
                                     ...
                                     $htmlContent.='<tr style="height:25px;border:0px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;4. LD Assistance</td>';

                                     $htmlContent.='<td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($ld_price, 2).'</td>';
                                   ...
                                   $query_doff="SELECT refun_deposit FROM tbl_vehicle_rantal  WHERE ve_id IN ($car_id)";
                                    ...
                                    $deposit_off=0;
                                      ...
                                      <td align="right" style="border:1px solid #000000;" nowrap="">$'.number_format($deposit_off, 2).'</td></tr>';

                                    $total_due=$ld_price+$deposit_off;

                                      $htmlContent.='<tr style="height:25px;border:0px!important">
                                      <td align="left" colspan="3" style="border:1px solid #000000;padding-right:5px" nowrap="">&nbsp;6. Due Amount </td>
                                      <td align="right" style="border:1px solid #000000;background:#e6e6e6;font-weight:bold;" nowrap="">$'.number_format($total_due, 2).'</td>
                                      </tr>
                                      </tbody>
                          </table>
                    </td></tr></tbody>
      ...
      <!-- <!— End —> -->
        ...
        <div class="col-md-4">
           ...
           <div class="financing_calculator margin-top-10" style="border:1px solid #ccc; border-radius:5px; ">
                     ...
                     <div class="financing_calculator margin-top-10" style="border:1px solid #ccc; border-radius:5px; ">
                            <h4 class="margin-bottom-25 margin-top-none" style="background: #ccc;margin-top: 0px; padding: 10px; font-size: 16px;"><span style="font-weight: 800">RickShaw </span> Info</h4>
                            <div class="table-responsive" style="padding:10px;">
                                <table class="table no-border no-margin">
                                    <tbody>
                                        <?php
...
<div class="financing_calculator margin-top-10" style="border:1px solid #ccc; border-radius:5px; ">
                            <h4 class="margin-bottom-25 margin-top-none" style="background: #ccc;margin-top: 0px; padding: 10px; font-size: 16px;"><span style="font-weight: 800">Interest Place</span> Info</h4>
                            <div class="table-responsive" style="padding:10px;">
                                <table class="table no-border no-margin">
                                    <tbody>
                                       <?php
                                       ...
                                       if(!isset($province_id)) {
                                          $pro_id="";
                                           ...
                                           $pro_id=$_SESSION['province_id'];
                                            $sql ="SELECT * FROM  tbl_province   WHERE pv_id='$province_id'";
...
$(document).ready(function()
{
        ...
        $("#txt_city_parent").on('click',function()
        {
        var country_id=$("#txt_city_parent").val();
        ...
        $("#sub_city").html(data);
                ...
                // province
          $("#form_provice").submit(function( event ) {
            alldata = $("#identity_equipment").val();
            if(alldata==''){
              $("#check_validate").html("Please Select One");
           ...
           $("#product_condition").on('click',function()
          {
              $('.chauffeur').css("display", "none");
              $('.product_book').css("display", "block");
           ...
           $("#chauffeur").on('click',function()
          {
               $('.chauffeur').css("display", "block");
               $('.product_book').css("display", "none");

          });

             $("#driver_condition").on('click',function()
          {
               $('.chauffeur').css("display", "block");
               $('.product_book').css("display", "none");
 ...
 $("#form_interest").submit(function( event ) {
            alldata_inter = $("#identity_interest").val();
            car_order_id=$("#identity_interest").val();
            if(alldata_inter==''){
              $("#alert_interest").html("Select Interest Place Rental");

              return false;
            }
            else if(car_order_id==""){
             $("#alert_interest").html("Select Interest Place Rental");
              return false;
            }
            else{
  ...
  $("#form_drive").submit(function( event ) {
            ...
            car_order_id=$("#identity_car").val();
            rich_shaw_id=$("#identity_richshaw").val();
            if(alldata==''){
              $("#check_drive").html("Please Select Chauffeur Rental");

             // return false;
            }
            else if (car_order_id=="" && rich_shaw_id==""){
               $("#check_drive").html("Please Select Vehicle OR RickShaw Type");
               // return false;
            }
            // else if(car_order_id==""){
            //  $("#check_drive").html("Please Select VEHICLE Type");
            //   return false;
            // }
            // else if(rich_shaw_id==""){
            //  $("#check_drive").html("Please Select RickShaw Type");
            //   return false;
            // }
            else{
              return true;
...
$(".tap_one").on("click",function() {
  $(".hiiden_tap_click_one").css("display","none");
  $(".display_hidden_rich_car").css("display","none");
});

$("#tap_car").on("click",function() {
  $(".display_hidden_rich_car").css("display","block");
});

$("#tap_driver").on("click",function() {
  $(".display_hidden_rich_car").css("display","none");
   $("#check_drive").html("");
});
$("#tap_tour").on("click",function() {
  $(".display_hidden_rich_car").css("display","none");
});
$("#tap_accessory").on("click",function() {
  $(".display_hidden_rich_car").css("display","none");
});
</script>
<script>
