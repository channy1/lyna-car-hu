          ...
          <div class="card card-outline card-info">
            ...
            <!-- /.card-header -->
				...
				<div class="form-group">
                    ...
                    <input type="text" class="form-control" name="redirect_url" placeholder="Enter Title"   required >
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="txt_promotion" placeholder="Enter Title"   required >
                  </div>

                  <div class="form-group">
                    <label >Promotion (Kh):</label>
                    <input type="text" class="form-control" name="txt_promotion_kh" placeholder="Enter Title"   required >
                  </div>
